                ...
                <div className="grid grid-cols-2 items-center size-full px-10">
                    ...
                    <div className="space-y-10 px-10">
                        <div className="space-y-6">
                            <div className="font-extrabold text-5xl">We <span className="text-[var(--salmon-orange)]">don't</span> inflate our prices!</div>
                            <div className="text-lg">Pay for what you use. Don't let pricey services f*ck you over! Most services charge way too much for their AI integrated services, when they don't need to.</div>
                        </div>
                        <CallToActionButton>
                            Just join bro.
                        </CallToActionButton>
            ...
            <div className="w-lvh h-[150px] bg-[var(--purple-black)] flex items-center px-10">
                <div className="flex gap-2">
                    <div className="text-white flex">
                        Made by 
                        <Link href={"https://www.instagram.com/j4ckyhnc/"} className="underline text-purple-300 flex ml-1">
                            <Image
